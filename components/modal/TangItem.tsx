    ...
    >
      ...
      >
        ...
        <div className="relative h-full text-[#fff] text-[16px] lg:text-[15px] px-[20px] py-[30px] md:px-[35px] md:py-[35px]">
          ...
          <p className="italic text-[#ff0000] text-[14px] text-center my-[10px]">
            Lưu ý: Tên tài khoản phải viết đúng chữ hoa và chữ thường
          </p>
          <div className="flex gap-[10px] justify-center">
            <button className="block bg-btn-tangngay bg-contain bg-no-repeat w-[116px] h-[40px] md:w-[195px] md:h-[67px]"></button>
